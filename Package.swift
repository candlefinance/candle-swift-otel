...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/candlefinance/swift-nio.git", exact: "2.82.1-candle"),
        .package(url: "https://github.com/candlefinance/swift-nio-ssl.git", exact: "2.30.0-candle"),
