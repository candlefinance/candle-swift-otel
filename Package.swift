...
let package = Package(
    ...
    dependencies: [
        .package(name: "candle-swift-distributed-tracing", url: "https://github.com/candlefinance/candle-swift-distributed-tracing.git", branch: "fix-candle-1.2.2"),
        ...
        .package(name: "candle-swift-async-algorithms", url: "https://github.com/candlefinance/candle-swift-async-algorithms.git", branch: "fix-candle-1.0.4"),
        .package(name: "candle-swift-service-lifecycle", url: "https://github.com/candlefinance/candle-swift-service-lifecycle.git", branch: "fix-candle-2.8.0"),
        ...
        .package(name: "candle-swift-metrics", url: "https://github.com/candlefinance/candle-swift-metrics.git", branch: "fix-candle-2.7.1"),
        .package(name: "candle-swift-w3c-trace-context", url: "https://github.com/candlefinance/candle-swift-w3c-trace-context.git", branch: "fix-candle-1.0.0-beta.3"),

        // MARK: - OTLPCore

        .package(name: "candle-swift-protobuf", url: "https://github.com/candlefinance/candle-swift-protobuf.git", branch: "fix-candle-1.30.0"),
        ...
        .package(name: "candle-async-http-client", url: "https://github.com/candlefinance/candle-async-http-client.git", branch: "fix-candle-1.27.0"),
